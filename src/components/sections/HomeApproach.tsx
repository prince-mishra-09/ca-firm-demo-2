...
export function HomeApproach() {
 ...
 return (
 <section className="py-10 md:py-16 lg:py-20 bg-secondary border-y border-border">
 ...
 <div className="h-16 w-16 rounded-sm bg-white border border-border flex items-center justify-center mb-6">

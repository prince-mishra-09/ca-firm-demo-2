...
export function Footer() {
 ...
 <p>Phone: <a href={`tel:${siteConfig.contact.phone.replace(/[^0-9+]/g, '')}`} className="hover:text-white transition-colors">{siteConfig.contact.phone}</a>, <a href={`tel:${siteConfig.contact.phoneAlt.replace(/[^0-9+]/g, '')}`} className="hover:text-white transition-colors">{siteConfig.contact.phoneAlt}</a></p>
 </address>
 </div>
 </div>
 ...
 <p>© {currentYear} {siteConfig.fullName}. All rights reserved. FRN: {siteConfig.frn}</p>

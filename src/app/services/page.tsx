  ...
  return (
    <div className="flex flex-col w-full bg-background">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-0 border-t border-border">
            {services.map((service, index) => {
              ...
              return (
                <div key={service.id} className="group py-16 md:py-24 border-b border-border hover:bg-muted/30 transition-colors duration-500">
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start">
                    ...
                    <div className="lg:col-span-7 flex gap-6 md:gap-10">
                      ...
                      <div className="flex flex-col">
                        ...
                        <h2 className="text-3xl md:text-4xl font-heading font-bold text-primary mb-4 tracking-tight group-hover:text-accent transition-colors">
                          {service.title}
                        </h2>
      ...
      <section className="py-24 bg-secondary">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-12 bg-background p-8 md:p-12 rounded-2xl border border-border shadow-sm">
            ...
            <div className="shrink-0 w-full md:w-auto">
              <Link
                href="/contact"
                className="inline-flex h-12 w-full items-center justify-center rounded-md bg-primary px-8 text-base font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 whitespace-nowrap"
              >
                Request Callback
              </Link>
            </div>

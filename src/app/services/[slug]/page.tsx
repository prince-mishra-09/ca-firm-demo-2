...
export default async function ServiceDetailPage({ params }: ServicePageProps) {
 ...
 <div className="mt-12 p-8 bg-secondary/30 border border-border rounded-sm">
 ...
 <div className="bg-background border border-border rounded-sm p-8 h-full transition-all duration-300 hover: hover:border-primary/20 flex flex-col">
 ...
 {/* 9. Contact */}
 <section className="py-10 md:py-16 lg:py-24 bg-primary text-primary-foreground border-t border-primary/20">
 <div className="container mx-auto px-4 sm:px-6 lg:px-8">
 ...
 <Link
 href="/contact"
 className="inline-flex h-14 items-center justify-center rounded-md bg-white px-10 text-lg font-medium text-primary transition-colors hover:bg-white/90"
 >
 Contact the Firm
 </Link>
 </div>

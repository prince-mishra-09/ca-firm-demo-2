...
export default function EmiCalculatorPage() {
 ...
 <h1 className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-primary mb-4">EMI Calculator</h1>
 ...
 <span className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-accent">{formatCurrency(emi)}</span>
 </div>

      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          <div className="mb-12">
            ...
            <h1 className="text-3xl md:text-4xl font-heading font-bold text-primary mb-4">Document Checklist</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
            ...
            <div className="lg:col-span-4">
              <div className="bg-secondary/30 border border-border rounded-xl p-4 md:p-6 sticky top-24">

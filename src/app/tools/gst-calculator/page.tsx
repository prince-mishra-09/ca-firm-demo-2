      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          <div className="mb-12">
            ...
            <h1 className="text-3xl md:text-4xl font-heading font-bold text-primary mb-4">GST Calculator</h1>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-background border border-input rounded-md px-4 py-3 text-lg font-medium text-primary shadow-sm focus:outline-none focus:ring-2 focus:ring-accent focus:border-accent transition-colors"
                  />
                </div>
              ...
              <div className="bg-primary text-primary-foreground p-8 md:p-10 rounded-2xl shadow-lg flex-grow flex flex-col justify-center">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-between items-end pt-4">
                    ...
                    <span className="text-4xl md:text-5xl font-heading font-bold text-white">{formatCurrency(finalAmount)}</span>
                  </div>
                </div>

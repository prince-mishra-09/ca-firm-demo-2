...
export default function ComplianceCalendarPage() {
 ...
 <h1 className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-primary mb-4">Compliance Calendar</h1>
 ...
 {/* Filters */}
 <div className="bg-secondary/30 border border-border p-6 rounded-sm mb-12 space-y-6">

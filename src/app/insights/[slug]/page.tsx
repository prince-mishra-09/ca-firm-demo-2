...
export default async function InsightDetailPage({ params }: InsightPageProps) {
  ...
  return (
    <div className="flex flex-col w-full bg-background">
      ...
      <article className="pt-16 pb-24 md:pt-24 md:pb-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="prose prose-lg md:prose-xl max-w-none text-foreground/80 prose-headings:font-heading prose-headings:text-primary prose-a:text-accent prose-a:no-underline hover:prose-a:underline prose-blockquote:border-accent prose-blockquote:bg-secondary/30 prose-blockquote:py-1 prose-blockquote:px-6 prose-blockquote:rounded-r-lg">
            ...
            <div className="mt-16 p-8 bg-secondary/30 border border-border rounded-xl not-prose">
        ...
        <section className="py-24 bg-muted/30 border-y border-border">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 flex justify-center md:hidden">
              <Link 
                href="/insights" 
                className="inline-flex h-12 items-center justify-center rounded-md border border-input bg-background px-8 text-base font-medium shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground hover:border-accent w-full uppercase tracking-widest"
              >
                View all insights
              </Link>
            </div>

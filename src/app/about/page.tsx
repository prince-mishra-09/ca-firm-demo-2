...
export default function AboutPage() {
 ...
 {/* 1. Page Hero */}
 <section className="pt-16 pb-12 md:pt-24 md:pb-16 lg:pt-32 lg:pb-24 bg-background border-b border-border">
 ...
 <div className="prose prose-lg text-foreground/80 max-w-none">
            <p>
              Established in {siteConfig.establishedYear}, {siteConfig.fullName} was founded on a singular premise: that complex financial and regulatory environments demand more than routine compliance. They require strategic foresight, deep institutional knowledge, and an unwavering commitment to quality.
            </p>
            <p>
              Our professional philosophy is centered on the "Client First" approach. We believe in providing accurate, practical solutions that work in reality, not just making things look good on paper. We approach every engagement with a conservative, research-backed methodology, ensuring that our advisory is strictly aligned with current statutory frameworks.
            </p>
            <p>
 ...
 <div className="py-4 flex justify-between gap-4">
 <dt className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Partners / Leadership</dt>
 <dd className="text-sm font-semibold text-primary text-right">5</dd>
 </div>
 <div className="py-4 flex justify-between gap-4">
 <dt className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Peer Review Status</dt>
 <dd className="text-sm font-semibold text-primary text-right">[TO BE CONFIRMED]</dd>
 </div>
 <div className="py-4 flex justify-between gap-4">
 ...
 <section className="py-10 md:py-16 lg:py-24 bg-background border-t border-border">
 <div className="container mx-auto px-4 sm:px-6 lg:px-8">
 ...
 {/* 5. Partners */}
 <section className="py-10 md:py-16 lg:py-24 bg-muted/50 border-t border-border">
 <div className="container mx-auto px-4 sm:px-6 lg:px-8">
 <div className="max-w-3xl mb-16">
 <h2 className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-primary mb-6">
 Leadership
 ...
 {team.map((partner) => (
 <div key={partner.id} className="bg-background border border-border rounded-sm overflow-hidden flex flex-col sm:flex-row hover: transition-shadow">
              <div className="sm:w-2/5 relative bg-secondary aspect-[3/4] sm:aspect-auto overflow-hidden">
                {partner.imageUrl ? (
                  <div 
 ...
 <div className="bg-secondary/30 border border-border rounded-sm p-8 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="border-l-2 border-primary pl-4">
              <div className="text-3xl font-heading font-bold text-primary mb-2">5</div>
              <div className="text-sm font-semibold uppercase tracking-widest text-muted-foreground">Leadership Team</div>
            </div>
            <div className="border-l-2 border-primary pl-4">
              <div className="text-3xl font-heading font-bold text-primary mb-2">15</div>
              <div className="text-sm font-semibold uppercase tracking-widest text-muted-foreground">Professional Team Members</div>
            </div>
          </div>
 </div>
 </div>
 ...
 {/* 7. Office */}
 <section className="py-10 md:py-16 lg:py-24 bg-muted border-t border-border">
 <div className="container mx-auto px-4 sm:px-6 lg:px-8">
 <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
 <div>
 <h2 className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-primary mb-8">
 Corporate Office
 </h2>
 ...
 <div className="space-y-2 text-foreground/80">
                <div className="flex justify-between w-64">
                  <span className="font-medium text-muted-foreground">{siteConfig.contact.workingHours}</span>
                </div>
 </div>
 </div>
 </div>
            ...
            <div className="bg-secondary border border-border rounded-sm overflow-hidden min-h-[400px] flex">
              <iframe 
